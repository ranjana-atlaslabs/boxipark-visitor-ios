...
struct Constant {
    ...
    public static let RETURENT_LOCAL_DATA: [ResturentLocalData]  = [ ResturentLocalData(id: 0 ,name: "Barnona", logo: #imageLiteral(resourceName: "barnonalogon"), color: #colorLiteral(red: 0.9520129561, green: 0.9357979894, blue: 0.893722713, alpha: 1)),
